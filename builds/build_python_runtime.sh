...
curl --fail --retry 3 --retry-connrefused --connect-timeout 15 --max-time 60 -o python.tgz "${SOURCE_URL}"
curl --fail --retry 3 --retry-connrefused --connect-timeout 15 --max-time 60 -o python.tgz.asc "${SIGNATURE_URL}"
